"""avideliveryservices_19928 URL Configuration
...
admin.site.site_header = "AviDeliveryServices"
admin.site.site_title = "AviDeliveryServices Admin Portal"
admin.site.index_title = "AviDeliveryServices Admin"

# swagger
api_info = openapi.Info(
    title="AviDeliveryServices API",
    default_version="v1",
    description="API documentation for AviDeliveryServices App",
)
